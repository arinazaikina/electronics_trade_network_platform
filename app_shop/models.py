...
class Supplier(MPTTModel):
    ...
    Иерархическая структура позволяет устанавливать зависимости между звеньями.
    """
    ...
    def can_be_deleted(self) -> Tuple[bool, Optional['Supplier']]:
        ...
        Возвращает кортеж из двух элементов - флаг, может ли поставщик быть удален, и объект поставщика
        с долгом (если есть).
        """
...
class Product(models.Model):
    """
    Модель продукта.
    Содержит информацию о продукте и его поставщике.
    """
